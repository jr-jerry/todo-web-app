        ...
        <div className="profile-section h-full ">
            ...
            <div className={`image-below-div h-[90%]  py-8 px-8 relative ${theme=="light"?"bg-gray-100 text-black":"bg-[#2c2c2c] text-white"}`}>
                ...
                <div className={`profile-items-section ${theme=="light"?"bg-white":"bg-[#232323]"} h-[40%] mb-4 py-4 px-6 flex gap-1 flex-col pt-12 items-start`}>
                    <div className="w-full"><motion.button className="w-full" whileHover={{scale:1.1 ,backgroundColor:theme=="light"?"#dcdcdc":"#2c2c2c", texColor:"black",transition:{duration:0.5}}} whileTap={{scale:0.95}} >All Task</motion.button></div>

                    <div className="w-full"><motion.button className="w-full" whileHover={{scale:1.1 ,backgroundColor:theme=="light"?"#dcdcdc":"#2c2c2c", transition:{duration:0.5}}} whileTap={{scale:0.9}} >Today</motion.button></div>
                    <div className="w-full"><motion.button className="w-full" whileHover={{scale:1.1 ,backgroundColor:theme=="light"?"#dcdcdc":"#2c2c2c", transition:{duration:0.5}}} whileTap={{scale:0.9}} >important</motion.button></div>
                    <div className="w-full"><motion.button className={`w-full ${theme=="light"?"text-black":"text-white"}`} whileHover={{scale:1.1 ,backgroundColor:theme=="light"?"#dcdcdc":"#2c2c2c", transition:{duration:0.5}}} whileTap={{scale:0.9}} >Logout</motion.button></div>
                </div>
